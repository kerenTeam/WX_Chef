 ...
 function empladd(){
  ...
  sercheck2.onclick = function (){
    ...
    if(sercheck2.checked){
          cd2.style.display="";
          serinput2.value=1;
           allmoney.innerHTML = parseFloat(allmoney.innerHTML)+parseFloat(serprice2.innerHTML);
    }
    else{
      cd2.style.display="none";
       serinput2.value=0;
       allmoney.innerHTML = parseFloat(allmoney.innerHTML)-parseFloat(servTotal2.value);
     }
...
//服务于数量加减
 function empdel2(){
  var sernum2 =serinput2.value;
        ...
        servTotal2.value = sernum2*parseFloat(serprice2.innerHTML); console.log(servTotal2.value);
        allmoney.innerHTML = parseFloat(allmoney.innerHTML)-parseFloat(serprice2.innerHTML);
 }
 function empladd2(){
  var sernum2 =serinput2.value;
