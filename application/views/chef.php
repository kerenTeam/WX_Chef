...
<!-- tab -->
  <div data-am-widget="tabs" class="am-tabs am-tabs-d2 am-shadow">
      <ul class="am-tabs-nav am-cf">
          ...
          <li class=""><a href="[data-tab-panel-2]">厨师</a></li>
      </ul>
            ...
            <ul class="am-list">  
                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left">
                  ...
                  <div class=" am-u-sm-8 am-list-main">
                      ...
                      <div class="months">月销<span class="foodname">100</span>份</div> 
...
<!-- footer -->
  <div data-am-widget="navbar" class="am-navbar am-cf am-navbar-default amft" id="">
      <div class="am-u-sm-8 a">
        <i class="am-icon-cart-arrow-down"><input type="text" id="fen" class="allmoney" value="0">份</i>
