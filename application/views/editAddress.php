    ...
    <script>
        ...
        MT_WM.TimeTracker = {rt: 1458034601180, st: Date.now()};
    ...
    <div class="fill-section-wrap">
        ...
        <ul class="fill-section address-section">
            <li>
                ...
                <a class="fill-section-right" href="/user/locaddr?type=3&source=2">
...
<script>
    require(['page/address/address_edit'],function(page) {
        page.init({
            ...
            type: '3',
            source: '2',
            csrfToken: 's/ldg1/SbZmgKhK2FakwBvshB75c/LRUMK7jaPimqPer4EwSaF5KCiGyq9VFLDnE' //anti-CSRF
        });
    });
</script>
