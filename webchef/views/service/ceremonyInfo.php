		...
		<div class="center bgc">
			<div class="elegance">
					...
					<div class="am-u-sm-5 cereForm">
						<form class="am-cf">
							...
							<div class="am-cf am-padding-sm qgray" id="my-sticky" data-am-sticky>
								<span class="red am-icon-cny am-text-xl" id="allmoney">34800.00</span><input type="hidden" value="" id="moneyall" placeholder="">
				...
				<div class="am-text-center ceremonyCtt priceR">
					<div class="am-g area">
											<div class="am-u-sm-12"><strong>迎宾区</strong></div>
										...
										<div class="am-g area">
											<div class="am-u-sm-12"><strong>仪式区</strong></div>
											<div class="am-u-sm-12">
												<div class="am-cf gsf">
										...
										<div class="am-g area">
											<div class="am-u-sm-12"><strong>宴会区</strong></div>
											<div class="am-u-sm-12">
												<div class="am-cf gsf">
										...
										<div class="am-g area">
											<div class="am-u-sm-12"><strong>局部装饰</strong></div>
											<div class="am-u-sm-12">
												<div class="am-cf gsf">
										...
										<div class="am-g area">
											<div class="am-u-sm-12"><strong>灯光设备</strong></div>
											<div class="am-u-sm-12">
												<div class="am-cf gsf">
										...
										<div class="am-g area">
											<div class="am-u-sm-12"><strong>专家团队</strong></div>
											<div class="am-u-sm-12">
												<div class="am-cf gsf">
										...
										<div class="am-g area">
											<div class="am-u-sm-12"><strong>演艺人员</strong></div>
											<div class="am-u-sm-12">
												<div class="am-cf gsf">
