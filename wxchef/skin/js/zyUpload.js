         ...
         return this.each(function() {
             ...
             this.createHtml = function() {
                 ...
                 if (para.dragDrop == 999) {
                     ...
                     html += '					<a style="height:' + '66.5px !important' + ';width:' + '66.5px !important' + ';" title="点击添加文件" id="rapidAddImg" class="add_imgBox" href="javascript:;">';
                     html += '						<div class="uploadImg" style="width:' + '66.5' + 'px">';
                     html += '							<img class="upload_image" src="skin/img/add_img.png" style="width:expression(this.width > ' + '66.5' + ' ? ' + '66.5' + 'px : this.width)" />';
                     html += '						</div>';
                     html += '					</a>';
                     html += '				</div>';
                     html += '			</div>';
             ...
             this.funDisposePreviewHtml = function(file, e) {
                 ...
                 if (file.type.indexOf("image") == 0) {
                     ...
                     html += '		</div>';
                     html += '	</div>';
                     html += '	<a style="height:' + '66.5px !important' + ';width:' + '66.5px !important' + ';" href="javascript:;" class="imgBox">';
                     html += '		<div class="uploadImg" style="width:' + '66.5' + 'px">';
                     ...
                     html += '	<div class="file_bar">';
                     html += '		<div style="padding:5px;">';
                     html += '			<p class="file_name">' + file.index + '</p>'; //<p class="file_name">' + file.name + '</p>';
                     html += delHtml; // 删除按钮的html
                     html += '		</div>';
                     html += '	</div>';
                     html += '	<a style="height:' + '66.5px !important' + ';width:' + '66.5px !important' + ';" href="javascript:;" class="imgBox">';
